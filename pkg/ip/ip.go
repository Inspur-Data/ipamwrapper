...
// IP version.
func ParseIP(version constant.IPVersion, s string, isCIDR bool) (*net.IPNet, error) {
	if isCIDR {
...
func ContainsIP(version constant.IPVersion, subnet string, ip string) (bool, error) {
...
func IsIP(version constant.IPVersion, s string) error {
